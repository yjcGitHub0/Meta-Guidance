...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.guidance = GuidanceGenerator(configs.enc_in, configs.seq_len, configs.k, configs.r)
    ...
    def imputation(self, x_enc, x_mark_enc, x_dec, x_mark_dec, mask):
        ...
        x_enc, weight = self.guidance(x_enc, 'norm', mask, x_interpolate)
        ...
        dec_out = self.guidance(dec_out, 'denorm', mask, x_interpolate)
